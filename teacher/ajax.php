...
if(isset($_POST['class_id'])){
    ...
    $stm=$pdo->prepare("SELECT subjects.name as subject_name,subjects.code as subject_code,
    subjects.id as subject_id FROM class_routine 
    ...
    foreach($subject_list as $newSubject) {
        $get_subject_options .= '<option value="'.$newSubject['subject_id'].'">'.$newSubject['subject_name'].' '.$newSubject['subject_code'].'</option>';
    }
